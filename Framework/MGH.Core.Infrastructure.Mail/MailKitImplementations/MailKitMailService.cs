...
namespace MGH.Core.Infrastructure.Mail.MailKitImplementations;
...
public class MailKitMailService : IMailService
{
    ...
    public void SendMail(Models.Mail mail)
    {
    ...
    private void EmailPrepare(Models.Mail mail, out MimeMessage email, out SmtpClient smtp)
    {
